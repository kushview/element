...
.. glossary::
   ...
   controller
     ...
     as audio programs like Element. They typically send :term:`MIDI`
   ...
   Apple Lossless Audio Codec
     ...
     :file:`mp4`). Element and many other programs are not compatible with ALAC.
     It is recommended to convert ALAC files to :term:`FLAC` for use in Element.
   ...
   metadata
     In general, any piece of information about a music file that Element uses
     ...
     `<https://en.wikipedia.org/wiki/ID3>`_ .
   ...
   OpenGL
     ...
     graphics. Element uses OpenGL to draw the waveform displays and spinning
     vinyl widgets.
   ...
   direct monitoring
     ...
     input signal in hardware with the output signal from Element. This
     bypasses the latency of sending the signal into the computer for Element to
