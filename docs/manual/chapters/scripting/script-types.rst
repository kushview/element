.. _el.AudioBuffer: https://kushview.github.io/element-ldoc/classes/kv.AudioBuffer.html
...
**symbol**      (string) A unique symbol for the param. Must be unique across all ports.
...
**symbol**      (table) Control ins and outs will all be assigned to a field keyed
                ...
                'volume', then you will also have `ctx.volume` available
