...
** is a string, as it was either generated by Lua or by 'message_handler'.
*/
...
static void print_version(void)
{
    ...
    lua_writeline();
    //   String elInfo = "Element ";
    //   elInfo << ProjectInfo::versionString << "  Copyright (C) 2014-%YEAR% Kushview, LLC";
    //   elInfo = elInfo.replace ("%YEAR%", String(Time::getCurrentTime().getYear()));
    //   lua_writestring(elInfo.toRawUTF8(), elInfo.length());
    //   lua_writeline();
}
